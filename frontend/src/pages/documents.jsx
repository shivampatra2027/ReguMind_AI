              ...
              <table className="min-w-full divide-y divide-slate-200 text-left text-sm">
                ...
                <tbody className="divide-y divide-slate-100 bg-white">
                  {documents.map((document) => {
                    ...
                    const mapLoading = loadingKey === `generate-map:${document.id}`;
                    const riskLoading = loadingKey === `generate-risk:${document.id}`;
                      ...
                      <tr key={document.id} className="align-top">
                        ...
                        <td className="px-6 py-5">
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button
                              type="button"
                              onClick={() => runDocumentAction(document, 'generate-map')}
                            ...
                            <button
                              type="button"
                              onClick={() => runDocumentAction(document, 'generate-risk')}
